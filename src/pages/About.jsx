      ...
      <div className="about-hero-split">
        ...
        <div className="about-content card-style">
          ...
          <div className="about-section">
            ...
            <div className="about-offers-grid">
              ...
              <div className="offer-card">
                ...
                <p>
                  Practice interviews with our intelligent AI coach that adapts
              ...
              <div className="offer-card">
                <h3>🔍 AI Job Search</h3>
                <p>
                  Find opportunities tailored to your skills and goals using
              ...
              <div className="offer-card">
                ...
                <p>
                  Get personalized career roadmaps and actionable steps to
                  achieve your goals.
                </p>
              </div>
            </div>
          ...
          <div className="about-section">
            ...
            <ul>
              <li>
                <strong>Personalized Experience:</strong> AI-driven
                recommendations based on your unique profile
              </li>
              <li>
                <strong>24/7 Availability:</strong> Access career guidance
                whenever you need it
              </li>
              <li>
                <strong>Professional Quality:</strong> Industry-standard tools
                and templates
              </li>
              <li>
                <strong>User-Friendly:</strong> Intuitive interface designed for
                all skill levels
              </li>
              <li>
                <strong>Secure & Private:</strong> Your data is protected and
                never shared
              </li>
            </ul>
          </div>
          ...
          <div className="about-section about-cta card-style fade-in">
            ...
            <p>
              ...
              dream careers with CareerCraft.
            </p>
          </div>
        </div>
      </div>
