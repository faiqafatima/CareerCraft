          ...
          <li className="dropdown" onClick={toggleServicesDropdown}>
            ...
            {servicesOpen && (
              <ul className="dropdown-menu">
                <li><Link to="/services/resume-builder">📝 Resume Builder</Link></li>
                <li><Link to="/services/ai-interview">🎤 AI Interview Practice</Link></li>
                <li><Link to="/services/job-search">🔍 Job Search</Link></li>
